...
public class webSocketServlet {
 ...
 /**
    ...
    * 连接关闭调用的方法
    ...
    public void onMessage(String message, Session session) {
        ...
        System.out.println("来自客户端的消息:" + parseObject.getMessage());
                 //群发消息
 ...
 80      */
     public void sendMessage(String _message) throws IOException, EncodeException {
         Message message = JSON.parseObject(_message, Message.class);
